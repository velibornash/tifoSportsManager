...
public class MatchBatchRunner {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numMatches; i++) {
            ...
            var homePlayers = MatchSimulationController.generateTeam("HOME", "Home");
            var awayPlayers = MatchSimulationController.generateTeam("AWAY", "Away");
        ...
        System.out.printf("  Yellow cards: %d  Red cards: %d%n", totalYellowCards, totalRedCards);
