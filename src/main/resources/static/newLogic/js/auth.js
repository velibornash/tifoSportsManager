...
function isAuthPage() {
    ...
    return path === '/' || path.endsWith('/login.html') || path.endsWith('/register.html') || path.endsWith('/newLogic/login.html') || path.endsWith('/newLogic/register.html');
}
...
export async function authFetch(url, options = {}) {
    ...
    if (response.redirected && (response.url.includes('/login.html') || response.url.includes('/newLogic/login.html'))) {
